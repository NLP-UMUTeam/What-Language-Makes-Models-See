...
from src.VLMBase import VLMModel
...
def run_single_image_tasks(
    ...
    for image_path in images:
        ...
        for task, question in single_questions.items():
            ...
            prompt = build_llava_style_prompt(task, question)
            started = time.time()

            try:
                vlm.set_prompt(prompt=prompt, image_path=str(image_path))
        ...
        for occupation_dir in occupations:
            for repetition in range(args.comparisons_per_occupation):
                ...
                for ordered in ordered_runs:
                    ...
                    prompt = build_llava_style_prompt(
                        "yes_no",
                        ordered["question"],
                    )
                    started = time.time()
                    ...
                    record = {
                        ...
                        "cipher_used": False,
                        "input_mode": "paired_images_side_by_side",
